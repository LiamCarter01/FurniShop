...
/// Bedroom data model for API communication.
///
...
class BedroomModel extends Bedroom {
  ...
  /// Convert this model back to its entity.
  Bedroom toEntity() => this;

  /// Create a [BedroomModel] from a [Bedroom] entity.
...
/// Bedroom dimensions model with JSON serialization.
class BedroomDimensionsModel extends BedroomDimensions {
  ...
  /// Parse dimensions from JSON map.
  ...
  /// Convert dimensions to JSON map.
  Map<String, dynamic> toJson() {
    return {
      'width': width,
      'height': height,
