...
class Bedroom extends Equatable {
  ...
  /// Image URL for the bedroom product.
  ...
  /// Bedroom category (e.g., 'bed', 'storage', 'accessories').
  final String category;

  /// Material used (e.g., 'wood', 'fabric').
...
/// Bedroom dimensions described in centimeters and kilograms.
