...
final getBedroomsByCategoryUseCaseProvider = Provider<GetBedroomsByCategoryUseCase>((ref) {
  final repository = ref.watch(bedroomRepositoryProvider);
...
class BedroomDetailNotifier extends StateNotifier<BedroomDetailState> {
  ...
  BedroomDetailNotifier(this._getBedroomByIdUseCase) : super(const BedroomDetailInitial());
  ...
  /// Update quantity for the bedroom.
...
final bedroomDetailProvider =
    StateNotifierProvider.family<BedroomDetailNotifier, BedroomDetailState, String>((ref, bedroomId) {
