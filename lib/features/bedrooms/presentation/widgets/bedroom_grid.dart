...
/// Grid widget to display bedroom products.
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ProductCard(
          ...
          onWishlistToggle: onWishlistToggle != null ? () => onWishlistToggle!(bedroom) : null,
        );
      },
    );
  }
...
/// Shimmer loading widget for bedroom grid.
...
/// Shimmer card used while bedrooms are loading.
