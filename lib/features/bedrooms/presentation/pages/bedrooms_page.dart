...
/// Bedrooms list page implementation.
...
class _BedroomsPageState extends ConsumerState<BedroomsPage> {
  ...
  Widget _buildBody(BedroomsState state) {
    return switch (state) {
      BedroomsInitial() => const core.LoadingWidget(message: 'Loading bedrooms...'),
      BedroomsLoading() => const core.LoadingWidget(message: 'Loading bedrooms...'),
      BedroomsLoaded(:final bedrooms, :final selectedCategory) => _buildLoadedContent(
          bedrooms: bedrooms,
          filteredBedrooms: (state as BedroomsLoaded).filteredBedrooms,
          categories: (state as BedroomsLoaded).categories,
          selectedCategory: selectedCategory,
        ),
      BedroomsError(:final failure) => core.ErrorWidget(
