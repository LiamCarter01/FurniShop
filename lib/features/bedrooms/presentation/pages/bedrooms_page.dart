...
class _BedroomsPageState extends ConsumerState<BedroomsPage> {
  ...
  Widget _buildBody(BedroomsState state) {
    return switch (state) {
      BedroomsInitial() => const core.LoadingWidget(message: 'Preparing bedrooms...'),
      BedroomsLoading() => const core.LoadingWidget(message: 'Loading bedrooms...'),
      BedroomsLoaded(
        :final bedrooms,
        :final selectedCategory,
        :final categories,
        :final filteredBedrooms,
      ) => _buildLoadedContent(
          bedrooms: bedrooms,
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              TextButton.icon(
                onPressed: () {
                  ref.read(bedroomsProvider.notifier).clearFilter();
                },
        ...
        Expanded(
          child: BedroomGrid(
            ...
            onBedroomTap: (bedroom) {
              _showBedroomSnackbar('${bedroom.name} tap coming soon');
            },
            onAddToCart: (bedroom) {
  ...
  void _showBedroomSnackbar(String message) {
  ...
  void _showAddToCartSnackbar(String name) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
