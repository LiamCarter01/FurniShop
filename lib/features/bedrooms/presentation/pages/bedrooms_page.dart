...
/// Bedrooms list page.
///
/// Mirrors the ChairsPage structure with filtering and a responsive grid.
...
class _BedroomsPageState extends ConsumerState<BedroomsPage> {
  ...
  Widget _buildBody(BedroomsState state) {
    return switch (state) {
      ...
      BedroomsLoaded(:final bedrooms, :final categories, :final filteredBedrooms, :final selectedCategory) => _buildLoadedContent(
          bedrooms: bedrooms,
