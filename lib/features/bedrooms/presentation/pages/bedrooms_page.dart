...
/// Bedrooms list page showing available bedroom products.
...
class _BedroomsPageState extends ConsumerState<BedroomsPage> {
  ...
  Widget _buildBody(BedroomsState state) {
    return switch (state) {
      ...
      BedroomsLoading() =>
        const core.LoadingWidget(message: 'Loading bedrooms...'),
      BedroomsLoaded(
        :final bedrooms,
        ...
        Expanded(
          child: BedroomGrid(
            ...
            onBedroomTap: (bedroom) {
              // TODO: Navigate to bedroom detail once implemented
            },
            onAddToCart: (bedroom) {
