                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const AppText(text: 'Description', variant: AppTextVariant.titleMedium),
                      const SizedBox(height: 8),
                      AppText(
                      ...
                      const SizedBox(height: 24),
                      const AppText(text: 'Specifications', variant: AppTextVariant.titleMedium),
                      const SizedBox(height: 12),
                      ...
                      if (bedroom.tags.isNotEmpty) ...[
                        const AppText(text: 'Tags', variant: AppTextVariant.titleMedium),
                        const SizedBox(height: 8),
                        Wrap(
                          spacing: 8,
                          runSpacing: 8,
                          children: bedroom.tags.map((tag) => Chip(label: Text(tag), backgroundColor: AppColors.surfaceVariant, materialTapTargetSize: MaterialTapTargetSize.shrinkWrap)).toList(),
                        ),
                      ],
                    ],
                  ),
  ...
  Widget _buildSpecRow(String label, String value) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          SizedBox(width: 100, child: AppText(text: label, variant: AppTextVariant.bodyMedium, color: AppColors.textSecondary)),
          Expanded(child: AppText(text: value, variant: AppTextVariant.bodyMedium)),
        ],
      ),
    );
  }
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Row(
                children: [
                  IconButton(onPressed: quantity > 1 ? () => ref.read(bedroomDetailProvider(widget.bedroomId).notifier).decrementQuantity() : null, icon: const Icon(Icons.remove), iconSize: 20, constraints: const BoxConstraints(minWidth: 40, minHeight: 40)),
                  SizedBox(width: 40, child: Center(child: AppText(text: quantity.toString(), variant: AppTextVariant.titleMedium))),
                  IconButton(onPressed: () => ref.read(bedroomDetailProvider(widget.bedroomId).notifier).incrementQuantity(), icon: const Icon(Icons.add), iconSize: 20, constraints: const BoxConstraints(minWidth: 40, minHeight: 40)),
                ],
              ),
            ),
            ...
            Expanded(
              child: AppButton(
                ...
                onPressed: bedroom.inStock ? () => _showAddToCartSnackbar(bedroom.name, quantity) : null,
