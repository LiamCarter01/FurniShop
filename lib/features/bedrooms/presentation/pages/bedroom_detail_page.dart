...
/// Detail page for a single bedroom product.
      ...
      child: SafeArea(
        child: Row(
          children: [
            ...
            AppButton(
              label: bedroom.inStock ? 'Add to Cart' : 'Out of Stock',
              onPressed: bedroom.inStock ? () => _showAddToCartSnackbar(bedroom.name) : null,
            ),
          ],
        ),
      ),
